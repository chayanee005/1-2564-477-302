...
if(lotto_number == random_number){
    ...
    .innerHTML = "ยินดีด้วย ! คุณถูกรางวัลเลขท้าย 3 ตัว"
}
else{
    document.getElementById("result")
    .innerHTML = "เสียใจด้วย ! คุณไม่ถูกรางวัลเลขท้าย 3 ตัว"
}
...
if(age == 12){
    ...
    console.log("ไปเรียน ม หนึ่ง นะ")
}
else if(age == 14){
    console.log("ไปเรียน ม สอง นะ")
}
